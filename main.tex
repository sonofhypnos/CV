...
\section*{Projects}
  \begin{itemize}
    ...
    \begin{itemize}
        \item Participated in a 2-day intensive research hackathon with two collaborators
        \item Explored lower-dimensional belief state geometry for steering Transformer models
        \item Produced a brief technical report on methods and findings
        \item \href{https://github.com/sonofhypnos/CV/blob/main/steering-models-belief-states.pdf}{Project summary}
    \end{itemize}
    \item \textbf{\href{https://github.com/sonofhypnos/fatebook.el}{fatebook.el}: Emacs Plugin for Fatebook}
    \begin{itemize}
